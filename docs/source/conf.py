...
myst_html_meta = {
    "description": "IP2Location Dart Package provides a fast lookup of geolocation information from IP address by using IP2Location database.",
    "keywords": "IP2Location, Geolocation, IP location, Dart",
...
html_title = "IP2Location Dart"

# html_baseurl = "https://ip2location-dart.readthedocs.io/en/latest/"